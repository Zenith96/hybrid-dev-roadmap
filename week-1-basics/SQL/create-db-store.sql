...
CREATE TABLE order_items (
  ...
  CONSTRAINT fk_order_items_orders FOREIGN KEY (order_id) REFERENCES orders(order_id) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE order_item_notes (
  ...
  CONSTRAINT fk_oin_order_items FOREIGN KEY (order_id, product_id) REFERENCES order_items(order_id, product_id) ON UPDATE CASCADE ON DELETE CASCADE
);
